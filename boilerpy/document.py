...
class TextDocument(object):
    ...
    def setTextBlocks(self, textBlocks):
        self.textBlocks = textBlocks
...
class TextBlock(object):
    ...
    def __init__(self, text, containedTextElements=set(), numWords=0, numWordsInAnchorText=0, numWordsInWrappedLines=0,
                 numWrappedLines=0, offsetBlocks=0):
    ...
    def __repr__(self):
        ...
        return "[" + str(self.offsetBlocksStart) + "-" + str(self.offsetBlocksEnd) + ";tl=" + str(
            self.tagLevel) + "; nw=" + str(self.numWords) + ";nwl=" + str(self.numWrappedLines) + ";ld=" + str(
            self.linkDensity) + "]\t" + ("CONTENT" if self.isContent else "boilerplate") + "," + str(
            self.labels) + "\n" + str(self.getText())
    ...
    def addLabels(self, *labels):
        ...
        if self.labels == None:
            self.labels = set()
        elif len(labels) == 1 and (type(labels[0]) == set or type(labels[0]) == list):
