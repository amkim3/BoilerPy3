...
class TestFilters(unittest.TestCase):
    defaultWords = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec fermentum tincidunt magna, eu " \
    ...
    def verifyContent(self, filtr, doc, contentArr, show=False):
        is_content_before = [block.isContent() for block in doc.getTextBlocks()]
        is_changed = filtr.process(doc)
        is_content = [block.isContent() for block in doc.getTextBlocks()]
        self.assertEqual(is_content, contentArr)
        self.assertEqual(is_changed, is_content != is_content_before)

    def test_markEverythingContent(self):
    ...
    def test_minClauseWords(self):
        ...
        doc = self.makedoc(["This is a clause, because it is separated by a comma.", "Real short",
                            "Lots of, very, very, very, small, clauses.",
                            "If acceptClausesWithoutDelimiter is false then clauses that dont end "
                            "in punctuation dont count"],
    ...
    def test_surroundContent(self):
        ...
        doc = self.makedoc([10, 20, 10, 5, 10, 20, 20, 10], [0, 0, 0, 5, 0, 0, 0, 0],
                           [True, False, True, False, True, False, False, True])
        defaultCondition = lambda tb: tb.getLinkDensity() == 0 and tb.getNumWords() > 6
        self.verifyContent(SurroundingToContentFilter(defaultCondition), doc,
    ...
    def test_labelToBoilerplate(self):
        ...
        doc = self.makedoc([10, 10, 10, 10], None, [True, True, True, True],
                           [lb_not, lb_maybe, [lb_not, lb_maybe], None])
        self.verifyContent(LabelToBoilerplateFilter(DefaultLabels.STRICTLY_NOT_CONTENT), doc,
    ...
    def test_labelToContent(self):
        ...
        lb_not = DefaultLabels.STRICTLY_NOT_CONTENT
        lb_maybe = DefaultLabels.MIGHT_BE_CONTENT
        doc = self.makedoc([10, 10, 10, 10], None, [False, False, False, False],
                           [lb_not, lb_maybe, [lb_not, lb_maybe], None])
    ...
    def test_expandTitleToContent(self):
        ...
        doc = self.makedoc([10, 10, 10, 10], None, [False, False, False, True],
    ...
    def test_articleMetadata(self):
        ...
        doc = self.makedoc([" May 1, 2009 8:00pm EST", "May not be date 1", "By Frank Sinatra",
                            "By looking at this sentence, you can see there is no author"], None,
...
class TestParser(unittest.TestCase):
    ...
    def test_anchor(self):
        template = "<html><body><p>*</p><div>*<a href='half.html'>*</a></div>" \
                   "<a href='full.html'><p>*</p></a></body></html>"
    ...
    def test_textDensity(self):
        ...
        blocks = doc.getTextBlocks()
        numArr = [[block.getNumWords(), block.numWordsInWrappedLines, block.numWrappedLines, block.getTextDensity()] for
                  block in blocks]
